      ...
      <div className="px-5 mb-6">
        <div className="bg-gradient-to-r from-[#D4FF90] to-[#32D74B] rounded-2xl p-5">
          ...
          <p className="text-[15px] text-black/80 mb-3">
            Historique illimité, graphiques avancés, programmes personnalisés et export des données.
          </p>
              ...
              {group.items.map((item, itemIndex) => {
                ...
                return (
                  ...
                  <div
                    ...
                    className={cn(
                      'flex items-center gap-3 px-4 py-4 transition-colors hover:bg-white/5 active:bg-white/10',
