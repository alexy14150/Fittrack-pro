        ...
        {user ? (
          <div className="bg-[#1C1C1E] rounded-2xl p-5">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#D4FF90] to-[#32D74B] flex items-center justify-center">
          ...
          <div className="bg-[#1C1C1E] rounded-2xl p-5">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-[15px] text-[#8E8E93] mb-3">Créez un compte pour sauvegarder vos données</p>
                <Button
                  onClick={() => setShowCreateProfile(true)}
                  className="h-9 px-4 bg-[#D4FF90] text-black hover:bg-[#c5f082] text-[15px] font-medium rounded-lg"
                >
                  Créer un compte
                </Button>
              </div>
      ...
      <div className="px-5 mb-6">
        <div className="bg-gradient-to-r from-[#D4FF90] to-[#32D74B] rounded-2xl p-5">
          ...
          <p className="text-[15px] text-black/80 mb-3">
            Débloquez tous les exercices, l'historique complet et les graphiques avancés.
          </p>
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      itemIndex !== group.items.length - 1 && 'border-b border-[#38383A]'
                    )}
                  >
                    ...
                    {'toggle' in item ? (
                      ...
                      <button 
                        onClick={item.action}
                        className="flex items-center gap-2 text-[15px] text-[#8E8E93]"
                      >
                        {item.value}
                        {item.showChevron && <ChevronRight size={18} />}
                      </button>
                    ) : item.showChevron ? (
